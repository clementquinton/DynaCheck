 ...
 *   <li>{@link featureModel.impl.AttributeImpl#isRuntime <em>Runtime</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends VariabilityElementImpl implements Attribute {
	/**
	...
	public void setRuntime(boolean newRuntime) {
		...
		runtime = newRuntime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.ATTRIBUTE__RUNTIME, oldRuntime, runtime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FeatureModelPackage.ATTRIBUTE__VALUE:
				return getValue();
			case FeatureModelPackage.ATTRIBUTE__RUNTIME:
				return isRuntime();
		}
